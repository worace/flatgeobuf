...
export async function* streamSearch(
  ...
  console.log(`tree items: ${numItems}, nodeSize: ${nodeSize}`);
  ...
  while (queue.length != 0) {
    ...
    console.log(`popped node: ${nodeRange}, queueLength: ${queue.length}`);
    ...
    for (let pos = nodeIndex; pos < end; pos++) {
      ...
      if (isLeafNode) {
        ...
        // console.log(`offset: ${offset}, pos: ${pos}, featureLength: ${featureLength}`);
