...
describe('ol module', () => {
    describe('Geometry roundtrips', () => {
        ...
        it('Heterogeneous geometry types', () => {
            ...
            console.log(geojson.readFeatures(expected));
            console.log(serialize(geojson.readFeatures(expected)));
            console.log(deserialize(serialize(geojson.readFeatures(expected))));
